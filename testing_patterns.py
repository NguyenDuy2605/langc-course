...
class QAChain:
    ...
    def __init__(self, llm=None):
        self.llm = llm or ChatAnthropic(model_name="claude-sonnet-4-6", temperature=0)
...
class IntegrationTestSuite:
    ...
    def __init__(self):
        self.llm = ChatAnthropic(model_name="claude-sonnet-4-6", temperature=0)
...
eval_llm = ChatAnthropic(model_name="claude-sonnet-4-6", temperature=0)
